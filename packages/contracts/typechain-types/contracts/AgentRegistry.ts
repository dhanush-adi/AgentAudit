...
export declare namespace AgentRegistry {
  export type MetadataEntryStruct = { key: string; value: BytesLike };

  export type MetadataEntryStructOutput = [key: string, value: string] & {
    key: string;
    value: string;
  };
}
...
export interface AgentRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, AgentRegistry.MetadataEntryStruct[]]
  ): string;
  encodeFunctionData(
...
export interface AgentRegistry extends BaseContract {
  ...
  "register(string,(string,bytes)[])": TypedContractMethod<
    [agentURI: string, metadata: AgentRegistry.MetadataEntryStruct[]],
    [bigint],
    "nonpayable"
  >;
