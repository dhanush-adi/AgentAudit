...
import { BarChart3, TrendingUp, Users, Activity, Bell, Settings, LogOut, Menu, X, LayoutDashboard, Bot, LineChart as LineIcon, FileText } from 'lucide-react';
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  background:   isActive ? 'linear-gradient(135deg, rgba(99,102,241,0.3), rgba(6,182,212,0.15))' : 'transparent',
